    ...
    <main className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-10">
      <section className="bg-base-200 backdrop-blur rounded-2xl shadow p-6 sm:p-10">
        ...
        <div className="overflow-x-auto mt-2">
          <table className="min-w-full text-left text-sm text-gray-700 border rounded-xl overflow-hidden">
        ...
        <p className="text-gray-700 mt-2">We may update this Cookie Policy from time to time. Please review it periodically.</p>
